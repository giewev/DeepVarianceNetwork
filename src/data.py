...
MAX_COMMENT_LENGTH= 250 #Change this. Ideally 10,000 but taking too much memory
root_dir = os.path.normpath("/Users/Mallikarjuna/Documents/SBU/Courses/Sem 2/NLP/HW/final_project/DeepVarianceNetwork")
...
#data_file_path = os.path.join(root_dir, "src/test.csv")
data_file_path = os.path.join(root_dir, "src/data/reddit_bipolar.csv")
embeddings_file_path = os.path.join(root_dir,"src/data/glove.6B.50d.txt")
all_redditors = load_raw_data(data_file_path)
embeddings = load_embeddings(embeddings_file_path,50)
all_redditors = vectorize_data(all_redditors,embeddings)
